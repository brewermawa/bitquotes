...
class Quote(models.Model):
    ...
    approved_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, null=True, blank=True, related_name="approved_quotes", verbose_name="Aprobada por")
    approved_at = models.DateTimeField(blank=True, null=True, verbose_name="Fecha de aprobación")
    sent_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, null=True, blank=True, related_name="sent_quotes", verbose_name="Enviada por")
    sent_at = models.DateTimeField(blank=True, null=True, verbose_name="Fecha de envío")
    won_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, null=True, blank=True, related_name="won_quotes", verbose_name="Ganada por")
    won_at = models.DateTimeField(blank=True, null=True, verbose_name="Fecha de cierre")
    lost_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, null=True, blank=True, related_name="lost_quotes", verbose_name="Perdida por")
